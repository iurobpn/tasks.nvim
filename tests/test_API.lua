...
T["setup()"]["sets exposed methods and default options value"] = function()
    ...
    -- public methods
    Helpers.expect.global_type(child, "_G.tasks.toggle", "function")
    Helpers.expect.global_type(child, "_G.tasks.disable", "function")
    Helpers.expect.global_type(child, "_G.tasks.enable", "function")

    -- config
    Helpers.expect.global_type(child, "_G.tasks.config", "table")
